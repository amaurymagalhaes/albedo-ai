  ...
  ({ modelPath, expression }, ref) => {
    ...
    useEffect(() => {
      ...
      const onTick = () => {
        ...
        const elapsed =
          performance.now() - lipSyncStartTimeRef.current - VISEME_LEAD_MS;
        ...
        if (active) {
          ...
          const next =
            current + (targetOpen * active.weight - current) * LERP_FACTOR;
        ...
        if (
          lastViseme &&
          elapsed > lastViseme.startMs + lastViseme.durationMs + 200
        ) {
